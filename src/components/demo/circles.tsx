...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-12 items-center justify-center rounded-full border-2 border-[#202225] bg-[#2c2c2c] p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className,
      )}
    >
      {children}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex w-full items-center justify-center overflow-hidden rounded-lg p-10 md:shadow-xl",
        className,
      )}
      ref={containerRef}
    >
