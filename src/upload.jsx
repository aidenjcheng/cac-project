...
import UploadFile from "./components/svg/uploadfile.jsx";
import X from "./components/svg/x.jsx";
...
const uploadroot = document.getElementById("root");
const upload = createRoot(uploadroot);
upload.render(<App />);
