...
export function AnimatedTabs({ activeTab, onTabChange }: AnimatedTabsProps) {
  ...
  return (
    <motion.div className="h-full animate-stagger border border-black/10 border-solid rounded-2xl px-1 py-1 box-border w-[70%] mx-auto bg-black/[0.1]">
      <motion.div className="relative flex justify-between ">
        <motion.div
          className="absolute bottom-0 left-0 h-[100%] bg-white border border-solid border-black/20 rounded-xl z-0 w-1/2"
          animate={{
