          ...
          {[
            ...
            <div className="w-full">
              <p className="pt-10 text-[rgb(190,190,190)]">
                ...
                schools. Nearly three-quarters of shooters under 18 get their
                guns from their homes or the homes of relatives. Reduce these
                risks by ensuring guns are stored unloaded in locked safes and
                out of reach. Parents can make a big difference since so many
                shooters under 18 have parents in their orbit also.
                ...
                cases educators, to petition courts to have guns taken
                temporarily away from individuals who are a danger to themselves
                or others.
                <br />
                <br />
                ...
                <br />
                <br />
                <strong>Implement Crisis Intervention Programs</strong>:
                Identify behavioral red flags and take appropriate action before
                they ramp up to violence. Effective crisis intervention requires
                linkages with organizations and community mental health support
                programs.
                <br />
                <br />
                ...
                <br />
                <strong>
                  Participate in Community-Based Violence Intervention
                  Initiatives
                </strong>
                <br />
                <br />
                ...
                support systems. These will have youth-centered activities such
                as employment opportunities and after-school programming.
                Restorative Discipline Practices Go beyond no-tolerance policies
                and punitive measures and shift toward restorative practices,
                including conflict resolution and mediation processes. This
                approach engenders a sense of community in schools and helps to
                reduce the likelihood of student marginalization or violent
                behavior.
                <br />
                <br />
                ...
                organizations. These may include handouts on gun safety and
                mental health support. If you put all of these mitigations into
                place, you will have done much toward preventing gun and knife
                violence in schools and make them safer, more supportive places
                for all students.
              </p>
            </div>,
          ]}
