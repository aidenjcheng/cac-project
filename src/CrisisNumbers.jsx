          ...
          {[
            ...
            <ul class="level-1">
                  ...
                  <li>
                    ...
                    <ul class="level-3">
                      <li>
                        ...
                        threatening behaviors or activities endangering
                  ...
                  <li>
                    ...
                    <ul class="level-3">
                      <li>
                        ...
                        agencies to find substance use treatment and
                        information.
                      </li>
                    </ul>
                  </li>
              ...
              <li>
                ...
                <ul class="level-2">
                  ...
                  <li>
                    ...
                    <ul class="level-3">
                      <li>
                        Provides confidential support and resources for victims
              ...
              <li>
                ...
                <ul class="level-2">
                  <li>
                    StopBullying.gov: No direct hotline, but offers resources
                    and information for dealing with bullying and cyberbullying.
                  </li>
                </ul>
              </li>
              <li>
