        ...
        {[
          ...
          <div className="w-full">
            <p className="pt-10 text-[rgb(190,190,190)]">
              ...
              immediate victims as well as on the larger educational context and
              ...
              These shootings involve tragic loss of life, serious injuries, and
              psychological trauma that impacts survivors and witnesses long
              term. Offenses range from targeted attacks to accidental
              ...
              settings have gotten to all times high levels, increasing over the
              past few years significantly (
              <a
              ...
              <strong className="med">
                The tragic shooting in Uvalde, Texas, at Robb Elementary School
                on May 24, 2022, left 21 people dead: 19 children and two
                teachers.{" "}
              </strong>{" "}
              Therefore, the said incident is one of the deadliest school
              shootings in the U.S. to date. This incident points out the
              terribly devastating effect of the occurrence of school shootings
              and possibility that this crisis will occur.{" "}
              <strong className="med">
                Other major events were the 2018 shooting at Marjory Stoneman
                Douglas High School in Parkland, Florida, that killed 17 people
              ...
              ). These examples prove the point that gun violence is, therefore,
              a consistent and even expanding risk for school settings.
              <br />
              <br />
              <strong className="med text-xl">
              ...
              Journal of the American Medical Association, it was concluded that
              there are higher rates of mental health problems like PTSD,
              ...
              ). Such a condition negatively influences academic performance as
              well as overall well-being, which is why some students need
              ...
              lost instructional time and decreased academic performance. If an
              institution has this kind of incident, it would be closed for a
              longer period and even disrupt the consecutive learning of the
              students. In addition, just the anticipation of violence causes an
              atmosphere of mistrust and insecurity among pupils and teachers,
              thus making effective learning difficult to achieve (
              <a
              ...
              psychological trauma, education interruption, economic costs, and
              far-reaching societal consequences. These are data and statistics
              that reveal the urgency to comprehend and deal with the complex
              dynamics of gun violence in places of learning.
            </p>
          </div>,
        ]}
      </Blog>
