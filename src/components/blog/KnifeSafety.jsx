        ...
        {[
          ...
          <div className="w-full">
            <p className="pt-10 text-secondary">
              ...
              <br />
              <br />
              Knife attacks and stabbings at high schools around the country are
              fast becoming an escalating problem. Many of the incidents result
              in serious injuries or even death, drawing attention to a dire
              ...
              show that knife crimes are a significant issue in America, today.
              The CDC states that
              <br />
              <br />
              <blockquote className="border-l-2 border-blue-400 pl-3">
                "approximately <NumberTicker value="4000" /> adolescents receive
                treatment for their injuries in connection with knife-related
                assaults each year" (
                <a
              ...
              <br /> Additionally, homicide accounts for about 1,600 youths per
              year, and many of these incidences <br />
              <br />
              <blockquote className="border-l-2 border-blue-400 pl-3">
              ...
              school set-up towards such abrupt violence with massive harm. The
              psychological impact on students and staff who witness or are
              involved in such incidents is profound, often leading to long-term
              trauma and fear.
              <br />
              <br />
              <strong className="med text-xl">
              ...
              Efforts to reduce knife violence within schools, through measures
              like increased security with metal detectors, surveillance
              cameras, and the presence of school resource officers, have shown
              varied results while simultaneously raising doubts about their
              effectiveness on the school environment. This debate remains on
              the balance between ensuring safety and maintaining a conducive
